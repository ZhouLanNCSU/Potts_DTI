...
c=40
  ...
  Matrix_list[[K]]<-rwish(5, 1.5*diag(3)/30)
  label_T1[1:cc,]<-1
  ...
  Data_T0<-lapply(1:N_T0, function(i) lapply(1:c^2,function(s) riwish(5,3*Matrix_list[[label_T0[s]]])))
  Data_T1<-lapply(1:N_T1, function(i) lapply(1:c^2,function(s) riwish(5,3*Matrix_list[[label_T1[s]]])))
