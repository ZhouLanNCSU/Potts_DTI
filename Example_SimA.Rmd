...
```{r message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
dd=cbind((1*t(matrix(colMeans(result$Diff[300:1000,])>0.5,40,40)))[,3:40],rep(0,40),rep(0,40))
```

```{r}
image(matrix(colMeans(result$Diff[300:1000,]),40,40))
```
